...
import { getAppLocale, getI18n, type SupportedLocale } from "./locales";
  ...
  const voiceItems: Electron.MenuItemConstructorOptions[] = voiceState.active
    ? [
        ...
        },
        {
          ...
          click: () =>
            getMainWindow()?.webContents.send("thumbar:toggle-deafen"),
        },
      ...
      ? [
          {
            ...
            click: () =>
              shell.openExternal(
                "ms-windows-store://pdp/?productid=XPDBZMTB5GVG3L",
              ),
          },
        ]
      : []),
    {
      label: i18n.trayReload,
